...
class _LunchState extends State<Lunch> {
  ...
  Widget _buildLunch() {
    ...
    if (_foodItem.item3 == 'Lunch') {
      if (_shouldAdd == true) {
        _addItem(_foodItem);
        widget.foodInfo = const Tuple2(Tuple3('air', 0, "lunch"), false);
        _shouldAdd = false;
      }
    }
        ...
        itemBuilder: (context, i) {
          return Card(
            ...
            child: ListTile(
              ...
              title: Text(
                'Meal: ' +
                    _lunch[i].item1.toString() +
                    '       Calories: ' +
                    _lunch[i].item2.toString(),
                style: _biggerFont,
              ),
              trailing: const Icon(
...
class Lunch extends StatefulWidget {
  ...
  Lunch({Key? key, required this.foodInfo}) : super(key: key);
